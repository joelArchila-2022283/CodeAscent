...
export class ModeloIntento {
    ...
    static async actualizar(
        ...
        const intentoActual =
            await this.obtenerPorId(id_intento);
        ...
        const respuesta_usuario =
            datosIntento.respuesta_usuario ??
            intentoActual.respuesta_usuario;

        const correcto =
            datosIntento.correcto ??
            intentoActual.correcto;

        const xp_obtenida =
            datosIntento.xp_obtenida ??
            intentoActual.xp_obtenida;
